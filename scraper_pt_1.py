...
# Collect link from primary article (top left of webpage, the left portion of html section <div class="tw2" section)
secure_links = []
...
# Collect links from secondary articles (top right of webpage. the right portion of html section <div class="tw2" section)
...
# Collect links from list of articles (center of webpage below the primary and secondary articles section, the list of <div class="mb10 tw3_01_2" sections)
